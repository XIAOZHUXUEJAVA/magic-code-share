            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                ...
                <Button
                  variant="outline"
                  size="sm"
                  onClick={() => updateTheme({ background: customBackground })}
                >
                  应用自定义背景
                </Button>
              </div>
              ...
              <div className="grid grid-cols-3 gap-2">
                <Button
                  ...
                  size="sm"
                  onClick={() => {
                    const gradient = generateGradient("#667eea", "#764ba2");
                    setCustomBackground(gradient);
                    updateTheme({ background: gradient });
                  }}
                >
                  紫蓝渐变
                </Button>
                <Button
                  ...
                  size="sm"
                  onClick={() => {
                    const gradient = generateGradient("#f093fb", "#f5576c");
                    setCustomBackground(gradient);
                    updateTheme({ background: gradient });
                  }}
                >
                ...
                <Button
                  ...
                  size="sm"
                  onClick={() => {
                    const gradient = generateGradient("#4facfe", "#00f2fe");
                    setCustomBackground(gradient);
                    updateTheme({ background: gradient });
                  }}
                >
